...
class SystemTest1(SystemTestBase):
    ...
    def test_27(self):
        ...
        app = self.prepare_test_context(
            file_data={
                ...
                "cats": ["CAT00|uncategorized", "CAT01|computer",],
                "borrow": ["001|kim123|2025-01-08|2025-01-15"],
                "borrow_hist": [],
            },
        )
        # 실행 및 입력값 제공
    ...
    def test_29(self):
        ...
        app = self.prepare_test_context(
            file_data={
                ...
                "isbn": ["ISBN07|Computer Science|Elon musk|CAT01"],
                "cats": ["CAT00|uncategorized", "CAT01|computer",],
                "borrow": ["002|lee123|2025-01-08|2025-01-15"],
                "borrow_hist": [],
            },
        )
        # 실행 및 입력값 제공
    ...
    def test_30(self):
        ...
        app = self.prepare_test_context(
            file_data={
                "users": ["kim123|12345678|kim123@naver.com|2020-01-01", "admin|12341234|123@gmail.com|"],
                "books": [
                    "001|ISBN07", "002|ISBN07", "003|ISBN07", "004|ISBN07",
                ],
                "isbn": ["ISBN07|Computer Science|Elon musk|CAT01"],
                "cats": ["CAT00|uncategorized", "CAT01|computer",],
                "borrow": ["001|kim123|2025-01-08|2025-01-15", "002|kim123|2025-01-08|2025-01-15", "003|kim123|2025-01-08|2025-01-15",],
                "borrow_hist": [],
            },
        )
        # 실행 및 입력값 제공
